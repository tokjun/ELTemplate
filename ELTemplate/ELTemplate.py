...
class ELTemplate(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "ELTemplate" # TODO make this more human readable by adding spaces
...
class ELTemplateWidget(ScriptedLoadableModuleWidget):
...
class ELTemplateLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('ELTemplateTest-Start','MyScreenshot',-1)
...
class ELTemplateTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_ELTemplate1()

  def test_ELTemplate1(self):
